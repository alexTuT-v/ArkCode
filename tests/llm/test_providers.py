...
from Arkcode.llm.providers.anthropic import AnthropicProvider, _wrap_anthropic_error
from Arkcode.llm.providers.openai import OpenAIProvider, _wrap_openai_error
from Arkcode.tools import ToolDefinition
...
def anthro_config() -> ProviderConfig:
    return ProviderConfig(
        name="Claude", protocol="anthropic", api_key="secret", model="test-model"
    )


def openai_config() -> ProviderConfig:
    return ProviderConfig(
        name="GPT", protocol="openai", api_key="secret", model="test-model"
    )
